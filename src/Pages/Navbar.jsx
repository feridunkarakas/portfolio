export default function NavBar({ active, setActive }) {
  return (
    ...
    <div className="absolute right-0 z-10 flex h-15 w-full items-center justify-start gap-8 overflow-x-auto rounded-xl rounded-b-4xl bg-zinc-800 px-4 text-zinc-200 text-l sm:justify-center sm:gap-10 xl:w-140 xl:gap-17 xl:px-0">
      <span
